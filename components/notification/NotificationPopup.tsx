...
export function NotificationPopup({ customTrigger }: NotificationPopupProps) {
    ...
    return (
        <div className="relative" ref={popupRef}>
            ...
            {/* Dropdown */}
            {isOpen && (
                <div className="absolute right-0 mt-2 w-80 sm:w-96 bg-white rounded-xl shadow-xl shadow-slate-200/50 border border-slate-100 z-[1100] overflow-hidden animate-fade-in origin-top-right">
